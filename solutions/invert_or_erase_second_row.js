...
function main(n) {
  /* 
     In this exercise, our starting grid has either blue or green in the top left corner.
     If it is blue, the program should move to the second row, and "invert" the colors
     of that entire second row.
     If the top-left box is green, the program should erase the entire second row.

     We can verify that this program works by running it in both scenarios:
     Go change the top-left color of the starting_grid to green!
  */
