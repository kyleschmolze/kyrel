...
function main(n) {
  /* 
     In this exercise, our task is rather simple:
     Find the blue dot in the top row, and move it one space to the right.
  */
  ...
  for(var j = 0; j < 5; j++) {
    ...
    /* Make sure to move right now, *even if we found the blue dot already*,
       otherwise we'll keep moving the blue dot over and over again!
       If you don't believe me, try putting this moveRight(); call into an
       else statement, and try it out on some paper */
    moveRight();
  }
}
